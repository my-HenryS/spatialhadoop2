 ...
 *
 */
@Partitioner.GlobalIndexerMetadata(disjoint = true, extension = "learned",
requireMBR = true)
public class LearnedPartitioner extends Partitioner {
   ...
   * and deserialize it
   */
  public LearnedPartitioner() {
  }

  @Override
  public void construct(Rectangle mbr, Point[] dummy, int numPartitions) {
    System.out.println(mbr);
    //mbr = new Rectangle(0,0,100000,100000);
    mbr = new Rectangle(0,0,100000,100000);
    numPartitions = 10*10;
    System.out.println(mbr+" "+numPartitions);
    x = mbr.x1;
    y = mbr.y1;
  ...
  public LearnedPartitioner(Rectangle mbr, int columns, int rows) {
    System.out.println(mbr);
    this.x = mbr.x1;
    this.y = mbr.y1;
  ...
  public LearnedPartitioner(Rectangle mbr, int numPartitions) {
